...
1. Get code and enter project: `git clone https://github.com/striblab/20180117-harassment.git && cd 20180117-harassment.git`
...
2. Copy files (update path as needed): `mkdir -p ../20180117-harassment/ && rsync -rav ./ ../20180117-harassment/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
